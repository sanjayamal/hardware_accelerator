...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../../floating_point_8/sim/floating_point_8.vhd" \
  2>&1 | tee -a vhdlan.log
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc floating_point_8_simv.daidir)
