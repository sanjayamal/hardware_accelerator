...
simulate()
{
  $xv_path/bin/xsim floating_point_8 -key {Behavioral:sim_1:Functional:floating_point_8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb floating_point_8.wdb xsim.dir)
