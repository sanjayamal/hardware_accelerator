...
HD_PWD='C:/ip_repo/neural_acc_v1_0_project/neural_acc_v1_0_project.runs/floating_point_9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_9.tcl
